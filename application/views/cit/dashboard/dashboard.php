                                            ...
                                            <div class="media-group feeds-group">
                                                ...
                                                <div class="media-group-item">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <div class="avatar">
                                                                <img src="<?= base_url() ?>assets/project/images/avtar-1.jpg" alt="" class="img-circle" width="40">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="media-group-item">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <div class="avatar">
                                                                <img src="<?= base_url() ?>assets/project/images/avtar-2.jpg" alt="" class="img-circle" width="40">
                                                            </div>
                                                        </div>
                                                        <div class="media-body">
                                                ...
                                                <div class="media-group-item">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <div class="avatar">
                                                                <img src="<?= base_url() ?>assets/project/images/avtar-3.jpg" alt="" class="img-circle" width="40">
                                                            </div>
                                                        </div>
                                                        <div class="media-body">
                                                ...
                                                <div class="media-group-item">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <div class="avatar">
                                                                <img src="<?= base_url() ?>assets/project/images/avtar-4.jpg" alt="" class="img-circle" width="40">
                                                            </div>
                                                        </div>
                                                        <div class="media-body">
                                                ...
                                                <div class="media-group-item">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <div class="avatar">
                                                                <img src="<?= base_url() ?>assets/project/images/avtar-5.jpg" alt="" class="img-circle" width="40">
                                                            </div>
                                                        </div>
                                                        <div class="media-body">
