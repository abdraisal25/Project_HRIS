<div class="modal-content" >
    ...
    <div class="modal-body" style="background-color:#333">
        ...
        <form class="class-horizontal style-form" action="<?php echo site_url(). 'lubangenak/perusahaan/level/action/delete' ?>" method="post">
            <?php foreach($data as $n) { ?>
            <div class="row form-group">
                <p style="text-align: center">Apakah anda ingin mengahapus <strong><?= $n{'level_nama'} ?>?</strong></p>
            </div>
            <div class="modal-footer justify-content-center">
                ...
                <input type="hidden" name="id" value="<?php echo $n{'id_level'}?>">
