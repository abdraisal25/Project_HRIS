...
<div class="modal-content" >
    ...
    <div class="modal-header" style="background-color:#36c6d3">
        <p class="heading lead col-md-8">Edit Jabatan</p>
    ...
    <div class="modal-body" style="background-color:#333">
        <div class="form-panel">
            <form class="class-horizontal style-form" action="<?php echo site_url(). 'lubangenak/perusahaan/jabatan/action/update' ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            ...
                            <?php foreach($parent as $g): ?>
                                <option <?= $n{'parent_id'} == $g{'id_jabatan'} ? 'selected':'' ?> value="<?= $g{'id_jabatan'} ?>"><?= $g{'jabatan_nama'} ?></option>
                            <?php endforeach ; ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row form-group">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="<?= $n{'jabatan_nama'}?>" required name="nama" placeholder="Masukan Nama Jabatan" class="form-control">
                            <input type="hidden" value="<?= $n{'id_jabatan'}?>" required name="id">
                            <input type="hidden" value="<?= $departement ?>" required name="departement">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            ...
                            <?php foreach($level as $g): ?>
                                <option <?= $n{'id_level'} == $g{'id_level'} ? 'selected':'' ?> value="<?= $g{'id_level'} ?>"><?= $g{'level_nama'} ?></option>
                            <?php endforeach ; ?>
                            </select>
                        </div>
                    </div>
