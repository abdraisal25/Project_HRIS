<div class="modal-content" >
    ...
    <div class="modal-header" style="background-color:#36c6d3">
        <p class="heading lead col-md-8">Hapus Departement</p>
    ...
    <div class="modal-body" style="background-color:#333">
        ...
        <form class="class-horizontal style-form" action="<?php echo site_url(). 'lubangenak/perusahaan/departement/action/delete' ?>" method="post">
            <?php foreach($data as $n) { ?>
            <div class="row form-group">
                <p style="text-align: center">Apakah anda ingin mengahapus <strong><?= $n{'departement_nama'} ?>?</strong></p>
            </div>
            <div class="modal-footer justify-content-center">
                <input type="hidden" required name="judul" value="<?= $nama ?>" class="form-control">
                <input type="hidden" value=<?= $divisi ?> required name="divisi">
                <input type="hidden" name="id" value="<?php echo $n{'id_departement'}?>">
