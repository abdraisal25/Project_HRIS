<div class="modal-content" >
    ...
    <div class="modal-header" style="background-color:#36c6d3">
        <p class="heading lead col-md-8">Tambah Divisi</p>
    ...
    <div class="modal-body" style="background-color:#333">
        <div class="form-panel">
            <form class="class-horizontal style-form" action="<?php echo site_url(). 'lubangenak/perusahaan/divisi/action/insert' ?>" method="post" enctype="multipart/form-data">
                <div class="row form-group">
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Divisi</label>
                        <div class="col-lg-10">
                            <input type="text" required name="nama" placeholder="Masukan Nama Divisi" class="form-control">
                            <input type="hidden" required name="jenus" value="<?= $jenus ?>" class="form-control">
