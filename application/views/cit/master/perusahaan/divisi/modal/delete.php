<div class="modal-content" >
    ...
    <div class="modal-header" style="background-color:#36c6d3">
        <p class="heading lead col-md-8">Hapus Divisi</p>
    ...
    <div class="modal-body" style="background-color:#333">
        ...
        <form class="class-horizontal style-form" action="<?php echo site_url(). 'lubangenak/perusahaan/divisi/action/delete' ?>" method="post">
            <?php foreach($data as $n) { ?>
            <div class="row form-group">
                <p style="text-align: center">Apakah anda ingin mengahapus <strong><?= $n{'divisi_nama'} ?>?</strong></p>
            </div>
            <div class="modal-footer justify-content-center">
                ...
                <input type="hidden" name="id" value="<?php echo $n{'id_divisi'}?>">
