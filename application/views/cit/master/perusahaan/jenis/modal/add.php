<div class="modal-content" >
    ...
    <div class="modal-header" style="background-color:#36c6d3">
        <p class="heading lead col-md-8">Tambah Jenis Usaha</p>
    ...
    <div class="modal-body" style="background-color:#333">
        <div class="form-panel">
            <form class="class-horizontal style-form" action="<?php echo site_url(). 'lubangenak/perusahaan/jenis/insert' ?>" method="post" enctype="multipart/form-data">
                <div class="row form-group">
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Jenis Perusahaan</label>
                        <div class="col-lg-10"><input type="text" required name="nama" placeholder="Masukan Jenis Perusahaan" class="form-control"></div>
                    </div>
                </div>
