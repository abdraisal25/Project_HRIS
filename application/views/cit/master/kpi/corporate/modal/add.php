<div class="modal-content" >
    ...
    <div class="modal-body" style="background-color:#333">
        <div class="form-panel">
            <form class="class-horizontal style-form" action="<?php echo site_url(). 'lubangenak/kpi/corporate/action/insert' ?>" method="post" enctype="multipart/form-data">
                <div class="row form-group">
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Corporate</label>
                        <div class="col-lg-10">
                            <input type="text" required name="nama" placeholder="Masukan Corporate" class="form-control">
