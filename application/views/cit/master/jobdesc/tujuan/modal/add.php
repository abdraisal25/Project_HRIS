<div class="modal-content" >
    ...
    <div class="modal-header" style="background-color:#36c6d3">
        <p class="heading lead col-md-8">Tambah Tujuan</p>
    ...
    <div class="modal-body" style="background-color:#333">
        <div class="form-panel">
            <form class="class-horizontal style-form" action="<?php echo site_url(). 'lubangenak/perusahaan/jabatan/jobdesc/tujuan/action/insert' ?>" method="post" enctype="multipart/form-data">
                <div class="row form-group">
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Tujuan</label>
                        <div class="col-lg-10">
                            <textarea name="nama" required cols="88" rows="3" placeholder="Masukan Tujuan Jabatan"></textarea>
