                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="row mail-header">
                                <div class="col-md-10">
                                    <h2>Daftar Tujuan Jabatan<?= $nama == null ? '': ' Dari '.$nama ?></h2>
                                </div>
                                <div class="col-md-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="ui-buttons" style="text-align:center">
                                                                ...
                                                                <button class="btn btn-primary btn-circle btn-icon" data-nama="<?= $nama ?>" data-jabatan="<?= $id ?>" data-id="<?= $n{'id_tujuan'} ?>" data-menu="delete" data-target="#modal" data-toggle="modal" title="Delete"><i class="fa fa-trash"></i></button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <?php $no++;} ?>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type : "get",
            url : '<?php echo base_url() ?>lubangenak/perusahaan/jabatan/jobdesc/tujuan/action/modal',
