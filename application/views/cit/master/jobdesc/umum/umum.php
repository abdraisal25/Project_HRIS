                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="row mail-header">
                                <div class="col-md-10">
                                    <h2>Daftar TanggungJawab Umum<?= $nama == null ? '': ' Dari '.$nama ?></h2>
                                </div>
                                <div class="col-md-2">
                                            ...
                                            <table id="datatable" class="table table-striped dt-responsive nowrap">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align:center">TanggungJawab Umum</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="ui-buttons" style="text-align:center">
                                                                ...
                                                                <button class="btn btn-primary btn-circle btn-icon" data-nama="<?= $nama ?>" data-jabatan="<?= $id ?>" data-id="<?= $n{'id_umum'} ?>" data-menu="delete" data-target="#modal" data-toggle="modal" title="Delete"><i class="fa fa-trash"></i></button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <?php $no++;} ?>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type : "get",
            url : '<?php echo base_url() ?>lubangenak/perusahaan/jabatan/jobdesc/tjumum/action/modal',
