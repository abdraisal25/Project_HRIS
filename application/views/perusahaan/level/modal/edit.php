<div class="modal-content" >
    ...
    <div class="modal-body" style="background-color:#333">
        <div class="form-panel">
            <form class="class-horizontal style-form" action="<?php echo site_url(). 'perusahaan/level/update_level' ?>" method="post" enctype="multipart/form-data">
                <?php foreach($data as $n) { ?>
                <div class="row form-group">
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Nama</label>
                        <div class="col-lg-10">
                            <input type="text" value=<?= $n{'standart_level_nama'}?> required name="nama" placeholder="Masukan Nama Standart Level" class="form-control">
                            <input type="hidden" value=<?= $n{'id_standart_level'}?> required name="id">
                        </div>
                    </div>
                </div>
                <?php } ?>
