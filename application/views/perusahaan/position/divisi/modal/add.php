<div class="modal-content" >
    ...
    <div class="modal-body" style="background-color:#333">
        <div class="form-panel">
            <form class="class-horizontal style-form" action="<?php echo site_url(). 'perusahaan/position/insert_divisi' ?>" method="post" enctype="multipart/form-data">
...
$(document).ready(function() {
    $('#level').select2({
        placeholder : "Pilih Standart Level Jabatan",
        allowClear : true
    });
