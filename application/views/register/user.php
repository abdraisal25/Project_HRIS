...
<body>
	...
	<div class="container-contact100">
        ...
        <div class="contact100-more flex-col-c-m" style="background-image: url('<?= base_url() ?>assets/register/images/bg-01.jpg');">
            ...
            <form class="contact100-form validate-form" action="<?= base_url() ?>registrasi/action/registrasi_user" method="post">
				<span class="contact100-form-title">
					User Registration
				</span>

				<label class="label-input100" for="phone">Enter Employee ID Number *</label>
				<div class="wrap-input100">
					<input class="input100" type="text" name="nip" placeholder="Enter Your Employee ID Number">
